...
class VersionFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $book = self::generateVersion($bookFragment);
        ...
        $chap1 = self::generateVersion($chap1Fragment);
        ...
        $chap1part1 = self::generateVersion($chap1Part1Fragment);
        ...
        $chap1part1V2 = self::generateVersion($chap1Part1Fragment);
        ...
        $chap1part2 = self::generateVersion($chap1Part2Fragment);
        ...
        $chap1part3 = self::generateVersion($chap1Part3Fragment);
        ...
        // chapter 1 part 3 V2
        $chap1part3V2 = self::generateVersion($chap1Part3Fragment);
        ...
        // chapter 1 part 3 V3
        $chap1part3V3 = self::generateVersion($chap1Part3Fragment);
        ...
        $chap2 = self::generateVersion($chap2Fragment);
        ...
        $chap2part1 = self::generateVersion($chap2Part1Fragment);
        ...
        // chap 2 part 1 V2
        $chap2part1V2 = self::generateVersion($chap2Part1Fragment);
        ...
        $chap2part2 = self::generateVersion($chap2Part2Fragment);
     ...
     * @throws \Exception
     */
    public static function generateVersion(Fragment $fragment): Version
    {
        $version = new Version();
